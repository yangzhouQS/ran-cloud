      ...
      <div class={ns.b()}>
        ...
        {store.scanState.scanning && (
          <div class={ns.e('progress')}>
            ...
            <div class={ns.e('progress-info')}>
              <span>已扫描: {store.scanState.progress}</span>
              <span>已找到: {store.keys.length}</span>
        ...
        {selectedKeys.value.length > 0 && (
          <div class={ns.e('toolbar')}>
            <span>已选中 {selectedKeys.value.length} 项</span>
        ...
        {store.activeConnectionId && (
          <div class={ns.e('status')}>
            <span>DB{store.activeDb}</span>
            <span>共 {store.keys.length} 个 Key</span>
          </div>
        )}
      </div>
    );
